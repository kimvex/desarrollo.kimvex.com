;(function () {
	...
	// Us Animate
	var usAnimate = function() {
		if ( $('#fh5co-us').length > 0 ) {	
			$('#fh5co-us .to-animate').each(function( k ) {
	...
	var usWayPoint = function() {
		if ( $('#fh5co-us').length > 0 ) {
			$('#fh5co-us').waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
				
					setTimeout(usAnimate, 100);
	...
	// Info Colaborativa Animate
	var infoColaborativaAnimate = function() {
		if ( $('#fh5co-info-colaborativa').length > 0 ) {	
			$('#fh5co-info-colaborativa .to-animate').each(function( k ) {
	...
	var infoColaborativaWayPoint = function() {
		if ( $('#fh5co-info-colaborativa').length > 0 ) {
			$('#fh5co-info-colaborativa').waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
				
					setTimeout(infoColaborativaAnimate, 100);
